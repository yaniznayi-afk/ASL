...
function switchInfoTab(tabId) {
    ...
    let html = `
        ...
        <div class="info-legend-container">
            ...
            <p class="legend-disclaimer">* Данные были взяты с открытых источников, согласованы с тремя ИИ(Gemini 3.1 pro, Claude 3.5, GPT-4) и по личным наблюдениям автора. <br><strong>МОГУТ НЕ СООТВЕТСТВОВАТЬ ДЕЙСТВИТЕЛЬНОСТИ</strong></p>
        </div>
    `;
